...
from common.utils.utils import CustomEncoder
from common.models.comparison import ExtractionComparisonData
...
class DataExtractionResult(BaseModel):
    ...
    def to_json(self, indent: Optional[int] = 4) -> str:
        ...
        """
        # model_dump_json() doesn't support cls parameter, so use json.dumps with model_dump()
        return json.dumps(self.model_dump(), indent=indent, cls=CustomEncoder)
